...
--
-- Host: 127.0.0.1
-- Generation Time: 01 Iun 2016 la 10:50
...
(2, 'Fine results', 'Badge for good results', 2),
(3, 'Best Results', 'Badge for best results', 1),
(4, 'Extraordinary Results', 'Badge for Extraordinary Results', 1);
...
(1, 'Context Creation', 'Creare Servlet Spring', 'Done'),
(2, 'Security Creation', 'Creare UserDetails Service', 'In Progress');
...
(3, 'Junit Testing', 'Creare clase de test');
...
--
ALTER TABLE `user_has_badge`
  ADD CONSTRAINT `fk_badge_id` FOREIGN KEY (`badge_id`) REFERENCES `badge` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
