...
public class LoggedUserView {
    ...
    @JsonCreator
    public LoggedUserView(Long id, String name, String surname, String username, String password, String email, String phone, String address, String image, Set<BadgeView> badges, Boolean admin) {
        Id = id;
        this.name = name;
