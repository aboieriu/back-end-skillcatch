...
public class UserService {
    ...
    @RequestMapping(value = "/skillcatch/api/projectGroup/{groupId}/user" , method = RequestMethod.GET)
    @ResponseBody
    ...
    @RequestMapping(value = "skillcatch/api/projectGroup/{groupId}/user/{userId}",method = RequestMethod.GET)
    @ResponseBody
    ...
    @RequestMapping(value = "/skillcatch/api/projectGroup/{groupId}/user/{userId}",method = RequestMethod.DELETE)
    @ResponseBody
    ...
    @RequestMapping(value = "/skillcatch/api/projectGroup/{groupId}/user/" , method = RequestMethod.POST)
    @ResponseBody
    ...
    @RequestMapping(value = "/skillcatch/api/projectGroup/{groupId}/user/{userId}", method = RequestMethod.PUT)
    @ResponseBody
