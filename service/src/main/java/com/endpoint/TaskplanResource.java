...
public class TaskplanResource {
    ...
    @RequestMapping(value = "/{taskPlanId}/awardBadge/{badgeId}",method = RequestMethod.PUT)
    @ResponseBody
    public void awardBadgeToTask(@PathVariable("taskPlanId")Long taskPlanId,@PathVariable("badgeId") Long badgeId){
        this.taskplanFacade.awardBadgeToTaskPlan(taskPlanId,badgeId);
    }
