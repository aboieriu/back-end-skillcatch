...
public class TaskplanResource {
    ...
    @ResponseBody
    public void createTaskPlan(@RequestBody TaskPlan taskPlan)throws Exception{
        this.taskplanFacade.createOne(taskPlan);
    }
    ...
    @RequestMapping(value = "/{userId}/getProjectUnAssignedTaskPlans",method = RequestMethod.GET)
    @ResponseBody
    public Set<TaskPlanView> getProjectUnAssignedTaskPlans(@PathVariable("userId")Long userId){
        return this.taskplanFacade.getProjectUnAssignedTaskPlans(userId);
    }
