...
CREATE TABLE `badge` (
  ...
  KEY `fk_badge_task1_idx` (`task_id`),
  CONSTRAINT `fk_badge_task1` FOREIGN KEY (`task_id`) REFERENCES `task` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `badge` VALUES (1,'Pro Java',NULL,'',1);
...
INSERT INTO `project_group` VALUES (1,'Java Group',NULL,0);
...
INSERT INTO `project_group_has_task_plan` VALUES (1,1);
...
INSERT INTO `project_group_has_user` VALUES (1,1);
...
INSERT INTO `role` VALUES (1,'ROLE_SUPER_DEV',NULL);
...
INSERT INTO `task` VALUES (1,'Eat',NULL);
...
INSERT INTO `task_plan` VALUES (1,'Tasks',NULL);
...
INSERT INTO `task_plan_has_task` VALUES (1,1);
...
INSERT INTO `user` VALUES (1,'admin','admin',NULL,NULL,'$2a$04$CkNURsStekYTLIqteHsvRejKziYJn1Tb2d4IeD25tp0iRSY8UkTZe',NULL,NULL);
...
INSERT INTO `user_has_task` VALUES (1,1);
...
-- Dump completed on 2016-02-19 14:54:27
